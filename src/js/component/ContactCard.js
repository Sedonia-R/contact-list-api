        ...
        <li className="list-group-item">
            <div className="row w-100">
                <div className="col-12 col-sm-6 col-md-3 px-0">
                    <img src="../../src/user_1.jpg" alt="John Doe" className="rounded-circle mx-auto d-block img-fluid" />
                </div>
                <div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
                    ...
                    <span className="text-muted small text-truncate">j.doe@email.com</span>
                </div>
            </div>
        </li>
    );
